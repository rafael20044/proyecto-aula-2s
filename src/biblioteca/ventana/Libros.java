...
public class Libros extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        buttAgregar.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        ...
        butBuscar.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        ...
        butCategoria.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
    ...
    private void buttAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttAgregarActionPerformed
        ...
        if (titulo.isEmpty() || autor.isEmpty() || codigo.isEmpty()) {
            ...
            JOptionPane.showMessageDialog(this, "El campo autor no debe tener numeros");
        }else if(tieneLetras(codigo)){
            JOptionPane.showMessageDialog(this, "El campo de codigo no debe tener letras");
        }else {
            libro.add(new Libro(titulo, autor, codigo));
            llenarLista();         
        }
