    ...
    private void txtCuposOcupadosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_txtCuposOcupadosMouseClicked
     ...
     private void elegirPuesto(){
         ...
         botMesaPc.addActionListener(buPc);   
             ...
             JOptionPane.showMessageDialog(this, "Los cupos de pc están llenos");
         }
         pane.add(botMesaPc);    
         ...
         if (mesaGrupal<10) {
             ...
             JOptionPane.showMessageDialog(this, "Los cupos de mesas grupales están llenos");
         }
         ...
         if (mesaIndividual<5) {
             ...
             JOptionPane.showMessageDialog(this, "Los cupos de mesas individuales están llenos");
         }
